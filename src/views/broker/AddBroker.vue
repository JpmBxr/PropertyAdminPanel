            ...
            <v-expansion-panel>
              ...
              <v-expansion-panel-content eager>
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="4" sm="12">
                    <v-text-field
                      ...
                      v-model="item.broker_license_number"
                      :rules="validationRulesRequired"
                      hide-details="auto"
                    >
                      <template #label>
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="4" sm="12">
                    <v-autocomplete
                      v-model="item.broker_association_id"
                      :items="brokerAssociationItems"
                      label="Select Broker Association"
                      item-text="broker_association_name"
