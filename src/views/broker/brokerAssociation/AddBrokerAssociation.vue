              ...
              <v-expansion-panel-content eager>
                <v-row class="mt-4">
                  <v-col cols="12" md="6" sm="12">
                    <v-text-field
                      dense
                      label="Broker Association Name"
                      v-model="item.broker_association_name"
                      :rules="validationRulesRequired"
                      hide-details="auto"
                    >
                      <template #label>
                        Broker Association Name
                        <span class="red--text">
                          <strong>*</strong>
                        </span>
                      </template>
                ...
                <v-row>
                  <v-col cols="12" md="4" sm="12">
                    <v-switch
                      ...
                      flat
                      label="Inactive Broker Association"
                      false-value="Active"
                      true-value="Inactive"
                    ></v-switch>
                  </v-col>
...
<script>
import { addBrokerAssociation } from "../brokerAssociation/addBrokerAssociation";
export default addBrokerAssociation;
</script>
