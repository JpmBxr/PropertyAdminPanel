    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.barangay_status="{ item }">
            <v-switch
              :color="item.barangay_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.barangay_status"
            ...
            <v-card-text class="py-4 px-2">
              ...
              >
                ...
                <v-row class="mx-auto d-flex" dense>
                  <v-col cols="12" md="12" class="pb-1">
                    <v-autocomplete
                      v-model="item.adjacent_barangay_id"
                      :items="adjacentBarangaysItems"
                      label="Select Adjacent Barangays"
...
<script>
import { barangayMaster } from "../Barangay/barangayMaster";
