    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.zonning_code_status="{ item }">
            <v-switch
              :color="item.zonning_code_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.zonning_code_status"
...
<script>
import { zonningCodeMaster } from "../ZonningCode/zonningCodeMaster";
export default zonningCodeMaster;
</script>
