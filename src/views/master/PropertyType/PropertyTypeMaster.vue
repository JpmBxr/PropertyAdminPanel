    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.property_type_status="{ item }">
            <v-switch
              :color="item.property_type_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.property_type_status"
...
<script>
import { propertyTypeMaster } from "../PropertyType/propertyTypeMaster";
