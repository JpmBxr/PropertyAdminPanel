    ...
    <v-card>
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.agri_type_status="{ item }">
            <v-switch
              :color="item.agri_type_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.agri_type_status"
...
<script>
import { agriTypeMaster } from "../AgriType/agriTypeMaster";
export default agriTypeMaster;
</script>
