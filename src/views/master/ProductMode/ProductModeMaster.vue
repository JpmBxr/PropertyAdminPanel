    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.product_mode_status="{ item }">
            <v-switch
              :color="item.product_mode_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.product_mode_status"
...
<script>
import { productModeMaster } from "../ProductMode/productModeMaster";
export default productModeMaster;
</script>
