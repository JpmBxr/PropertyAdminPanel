    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.specialization_status="{ item }">
            <v-switch
              :color="item.specialization_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.specialization_status"
...
<script>
import { specializationMaster } from "../Specialization/specializationMaster";
