    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.property_classification_status="{ item }">
            <v-switch
              :color="
              ...
              true-value="Active"
              v-model="item.property_classification_status"
              ...
              >
                <v-row class="mx-auto d-flex">
                  <v-col cols="12" md="12" class="pt-5 pb-2">
                    <v-text-field
                      v-model="item.property_classification"
                      dense
                      outlined
...
<script>
import { propertyClassificationMaster } from "../PropertyClassification/propertyClassificationMaster";
export default propertyClassificationMaster;
</script>
