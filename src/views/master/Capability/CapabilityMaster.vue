    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.capability_status="{ item }">
            <v-switch
              :color="item.capability_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.capability_status"
...
<script>
import { capabilityMaster } from "../Capability/capabilityMaster";
export default capabilityMaster;
</script>
