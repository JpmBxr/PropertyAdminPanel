    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.province_status="{ item }">
            <v-switch
              :color="item.province_status == 'Active' ? 'green' : 'red'"
              inset
              dense
              false-value="Inactive"
              true-value="Active"
              v-model="item.province_status"
...
<script>
import { provinceMaster } from "../Province/provinceMaster";
